(() => {
  const data_config = {
    'cdd_anom': {
      ...
      'colourscale': 'BrBG',
      'dp': 3,
      'title': 'Projected change in consecutive dry days',
      'units': 'no. of days [2030s w.r.t 2000s]',
    },
    'cdd_trend': {
      'centred': true,
      'colourscale': 'BrBG',
      'dp': 3,
      'title': 'Observed trend in consecutive dry days',
      'units': 'days/decade, 1990-2020',
    },
    'prdjf_anom': {
      'centred': true,
      'colourscale': 'BrBG',
    ...
    'prdjf_trend': {
      ...
      'colourscale': 'BrBG',
      'dp': 3,
      'title': 'Past change in winter rainfall',
      'units': 'mm/day/decade',
    },
    'prjja_anom': {
      'centred': true,
      ...
      'units': 'mm/day [2030s w.r.t 2000s]',
    },
    'prjja_trend': {
      'centred': true,
      'colourscale': 'BrBG',
      'dp': 3,
      'title': 'Observed trend in summer rainfall',
      'units': 'mm/day/decade, 1990-2020',
    },
    'rx5day_anom': {
      'centred': true,
      'colourscale': 'YlGnBl',
    ...
    'rx5day_trend': {
      ...
      'colourscale': 'YlGnBl',
      'dp': 3,
      'title': 'Past Change in rain falling over wettest 5 days of the year',
      'units': 'mm/day/decade',
    },
    'txx_anom': {
      'colourscale': 'YlOrRd',
      'dp': 3,
      'title': 'Coming change in temperature of warmest day of year',
      'units': '°C, 2030s w.r.t 2000s',
    },
    'txx_trend': {
      'colourscale': 'YlOrRd',
      'dp': 3,
      'title': 'Observed trend in temperature of warmest day of year',
      'units': '°C/decade',
    },
    't_anom': {
      'colourscale': 'YlOrRd',
      'dp': 3,
      'title': 'Coming change in annual temperature',
      'units': '°C [2030s w.r.t. 2000s]',
    },
    't_trend': {
      'colourscale': 'YlOrRd',
      'dp': 3,
      'title': 'Observed trend in annual temperature',
      'units': '°C/decade, 1990-2020',
    }
  };
